...
**Testing:**
```bash
npm run test           # Typecheck, vitest view tests, script tests
...
- Root `npm run test` is typecheck, vitest for `src/**/*.test.*`, and script tests. Backend: `cd backend && cargo test --locked`
- CI runs both.
