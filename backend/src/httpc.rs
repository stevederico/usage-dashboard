...
//! `stripe.rs` are private to that module. Quota collectors call Grok, Cursor,
//! and Anthropic. Zero-crate: libcurl is linked as a *system library*
